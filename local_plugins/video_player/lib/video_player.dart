...
class VideoPlayerValue {
  ...
  VideoPlayerValue.uninitialized() : this(duration: Duration.zero);

  VideoPlayerValue.erroneous(String? errorDescription)
      : this(duration: Duration.zero, errorDescription: errorDescription);
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
  ...
  Future<void> initialize() async {
    ...
    late Map<dynamic, dynamic> dataSourceDescription;
    ...
    final Map<String, dynamic>? response = await _channel
        .invokeMapMethod<String, dynamic>('create', dataSourceDescription);
  ...
  Future<int> get windowIndex async {
    ...
    return await _channel.invokeMethod<int>('windowIndex', <String, dynamic>{
          'textureId': _textureId,
        }) ??
        0;
  }
  ...
  Future<void> addMediaSource(
    ...
    int duration =
        await _channel.invokeMethod<int>('addMediaSource', <String, dynamic>{
              'textureId': _textureId,
              'index': index,
              'path': path,
              'isAsset': isAsset,
...
class _VideoPlayerState extends State<VideoPlayer> {
  ...
  Widget build(BuildContext context) {
    return (widget.controller.value.size == null ||
...
class _VideoProgressIndicatorState extends State<VideoProgressIndicator> {
  ...
  VideoProgressColors get colors => widget.colors ?? VideoProgressColors();
